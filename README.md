...
six input verbs, the three app verbs, the three read verbs, the log read and the screen recording
are callable over the
...
brings back a recording that is provably finished before it leaves the device, `read_logs`
