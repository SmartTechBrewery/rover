...
- **The mp4 muxer refuses a non-seekable output, so a normalised recording needs a host temp file
  ...
  touch the host's disk, and no path ever reaches an answer (D19).
